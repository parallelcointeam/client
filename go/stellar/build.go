...
type buildPaymentEntry struct {
	...
	DataLock sync.Mutex
	Data     buildPaymentData // Must hold dataLock to read or write.
}

type buildPaymentData struct {
	ReadyToReview bool
	ReadyToSend   bool
	// xxx is NotifySeqno needed?
	NotifySeqno int            // Next seqno for outgoing UIPaymentReview notifications
